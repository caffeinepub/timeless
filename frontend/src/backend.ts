...
export class Backend implements backendInterface {
    ...
    async defeatEnemy(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.defeatEnemy(arg0);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getGameState(arg0: bigint): Promise<{
        enemiesDefeated: bigint;
        score: bigint;
        ammunition: bigint;
        health: bigint;
    ...
    async increaseScore(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.increaseScore(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async rechargeWeapon(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.rechargeWeapon(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async takeDamage(arg0: bigint, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.takeDamage(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
